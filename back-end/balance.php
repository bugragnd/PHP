...
function request($method , $parameters) {
    ...
    $option = [
        ...
        CURLOPT_USERPWD => "__cookie__:f38fa34501273d115fe93c78982d1713b043d88362df4f1ae231a90d409ed874", //her girişte değişen username and password
...
$balanceinfo = request("getbalance",[]);
echo "" . json_encode($balanceinfo);
// $getbalance =request("getbalance,[]");
// $response = json_encode(["result" => $getbalance, "error" => ["code" => NUll, "message" => NULL]]);
// echo $response;
